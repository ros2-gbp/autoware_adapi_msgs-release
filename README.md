## autoware_adapi_msgs (jazzy) - 1.9.2-1

The packages in the `autoware_adapi_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy autoware_adapi_msgs` on `Fri, 31 Jul 2026 09:53:59 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.2-2

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_adapi_msgs` on `Fri, 31 Jul 2026 09:51:52 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.2-1

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_adapi_msgs` on `Fri, 31 Jul 2026 09:49:10 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.1-2

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_adapi_msgs` on `Sun, 16 Nov 2025 12:00:41 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.1-1

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble autoware_adapi_msgs` on `Sun, 16 Nov 2025 11:58:44 -0000`
...
## autoware_adapi_msgs (rolling) - 1.9.0-1

The packages in the `autoware_adapi_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling autoware_adapi_msgs -y` on `Tue, 11 Nov 2025 12:04:39 -0000`
...
## autoware_adapi_msgs (jazzy) - 1.9.0-1

The packages in the `autoware_adapi_msgs` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy autoware_adapi_msgs -y` on `Tue, 11 Nov 2025 11:58:40 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.0-2

The packages in the `autoware_adapi_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble autoware_adapi_msgs -y` on `Tue, 11 Nov 2025 11:54:51 -0000`
...
## autoware_adapi_msgs (humble) - 1.9.0-1
