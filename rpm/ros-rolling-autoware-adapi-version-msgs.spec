...
%global pkg_name autoware_adapi_version_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-autoware-adapi-version-msgs
Version:        1.9.1
Release:        1%{?dist}
...
* Thu Apr 30 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.9.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.9.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Takagi, Isamu <isamu.takagi@tier4.jp> - 1.9.0-1
- Autogenerated by Bloom
